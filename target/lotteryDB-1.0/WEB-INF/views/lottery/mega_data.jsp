  ...
  <div class="main-container">
  	...
  	<c:choose>
		...
		<!-- recordSection -->
  		...
  		<fieldset>
  			<form action="/mega/update/${mega.id}" method="POST" onsubmit="return submitData()">
    			...
    			<% } %>
    				<input type="hidden" name="megaball" id="pick1" value="0">
    			</div>
