		...
		<!-- recordSection -->
  		<div class="record-section">
  			...
  			<p class="data"> 
				...
				<span class="data-single">${powerball.powerball}</span>
			</p>
  		...
  		<fieldset>
  			<form action="/powerball/update/${powerball.id}" method="POST" onsubmit="return submitData()">
