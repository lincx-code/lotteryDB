...
public class MegaMillions {
	...
	public MegaMillions(int id, Date draw_date, int ball1, int ball2, int ball3, int ball4, int ball5, int megaball) {
		this.id = id;
	...
	public MegaMillions(Date draw_date, int ball1, int ball2, int ball3, int ball4, int ball5, int megaball) {
		this.draw_date = draw_date;
		this.ball1 = ball1;
		this.ball2 = ball2;
		this.ball3 = ball3;
	...
	public String toString() {
		return "{" + Constants.TOSTRING_PREFIX + "id : " + id + Constants.TOSTRING_PREFIX + "draw_date : " + draw_date
				...
				+ Constants.TOSTRING_PREFIX + "ball5 : " + ball5 + Constants.TOSTRING_PREFIX + "megaball : " + megaball
				+ "\n}";
	}
}
